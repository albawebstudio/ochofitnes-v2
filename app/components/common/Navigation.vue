...
<template>
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="https://ochofitness.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <NavLogo :alt="site.legalName" :fontControlled="false" class="h-8 text-primary dark:text-primary-200"/>
